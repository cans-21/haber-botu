...
1. `TELEGRAM_TOKEN` ve `CHAT_ID` değerlerini GitHub reponun
   **Settings → Secrets and variables → Actions** bölümüne ekle.
2. Bu repoyu GitHub'a yükle (bu dosyaların hepsiyle birlikte).
3. **Actions** sekmesinden workflow'un etkin olduğundan emin ol.
4. İlk çalıştırmada bot sadece mevcut haberleri kaydeder, bildirim
